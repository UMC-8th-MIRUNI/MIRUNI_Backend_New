...
UserErrorCode implements ErrorCode {
    ...
    USER_NOT_FOUND(HttpStatus.NOT_FOUND, "USER404_4", "사용자를 찾을 수 없습니다."),
    INVALID_PASSWORD(HttpStatus.BAD_REQUEST, "USER400_5", "비밀번호가 올바르지 않습니다."),
    AGREEMENT_REQUIRED(HttpStatus.BAD_REQUEST, "USER400_6", "필수 약관에 동의해야 합니다."),
    INVALID_TOKEN(HttpStatus.UNAUTHORIZED, "USER401_7", "유효하지 않은 토큰입니다."),
    USER_ALREADY_DELETED(HttpStatus.BAD_REQUEST, "USER400_8", "이미 탈퇴한 사용자입니다."),
